  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex flex-col items-center justify-center bg-indigo-950/100 rounded-lg p-3 space-y-2">
        <h2 className="text-lg font-semibold text-white/95 mb-2 tracking-tight">{title}</h2>
        <a 
          href={href}
...
const Info = [
  {
    title: "Team",
    delay: 0,
    lottieSrc: "https://lottie.host/5a7bbb4e-feb8-4e73-acbe-01795cb24c81/scA1Z2Gc6R.lottie",
    href: "/development"
  },
  {
    title: "Events",
    delay: 200,
    lottieSrc: "https://lottie.host/dccce0ee-94e1-46ca-b5d2-f6a539043191/aznFnjSDOz.lottie",
    href: "/design"
  },
  {
    title: "Academics",
    delay: 600,
    lottieSrc: "https://lottie.host/ae06fa59-3bc1-4326-aa0d-053f39a131bf/Gc2ODEKx8t.lottie",
    href: "/engineering"
  },
  {
    title: "Achievements",
    delay: 400,
    lottieSrc: "https://lottie.host/38209cd9-3a10-4ae6-b141-136dc27ecb42/C1KJqPHSEc.lottie",
    href: "/marketing"
  }
];
